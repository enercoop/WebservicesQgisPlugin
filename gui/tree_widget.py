...
from Webservices_Enercoop.gui.tree_items import TreeWidgetItem
...
class TreeWidget(QTreeWidget):
    ...
    """
    The tree widget used in the Webservices Enercoop dock
    """
    ...
    def set_tree_content(self, resources_tree):
        ...
        if resources_tree is None:
            QgsMessageLog.logMessage(
                ...
                u"dans le panneau de l'extension Webservices Enercoop.",
                tag=u"Webservices Enercoop",
                level=Qgis.Warning,
            )
