...
from Webservices_Enercoop.gui.dock import DockWidget
from Webservices_Enercoop.gui.about_box import AboutBox
from Webservices_Enercoop.gui.param_box import ParamBox
from Webservices_Enercoop.nodes.tree_node_factory import TreeNodeFactory
from Webservices_Enercoop.nodes.tree_node_factory import download_tree_config_file
...
class SimpleAccessPlugin:
    ...
    def createPluginMenu(self):
        ...
        self.plugin_menu = QMenu(u"Webservices Enercoop", plugin_menu)
